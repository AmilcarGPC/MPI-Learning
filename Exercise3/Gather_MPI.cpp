...
int main()
{
   ...
   //==========================================
   // MPI [4]: reunir todas las sumas parciales en el proceso 0
    if (taskid == 0) {
    ...
    // MPI [5]: calcular la suma global en el proceso 0
    if (taskid == 0) {
        sumaglob = 0.0;
        for (int i = 0; i < numtasks; i++) {
            sumaglob += sumasParciales[i];
        }
        free(sumasParciales);
    }
